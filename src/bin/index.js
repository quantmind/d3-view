...
command
    .version(version)
    .usage("[options] [file]")
    .description("Create a d3-require.js file with dependencies, additional javascript prepended and optional custom library setting")
    ...
    .option("-a, --append <files>", "Additional javascript files to append, comma separated")
